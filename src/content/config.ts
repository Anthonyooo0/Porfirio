export const siteConfig = {
  ...
  role: "Software Engineer(Automation & ML)",
  ...
  about: {
    bio: "Results-driven Software Engineer specializing in full-stack development and machine learning. I build scrapers, automations, and ML-powered tools that eliminate manual work and surface insights quickly. Currently pursuing General Engineering/Computer Science at NJIT while working as CTO & Co-Founder at Reminous and AI Software Engineer Intern at MAC Products. former NCAA Division 1 Track and Field athlete with a passion for turning complex technical challenges into simple, reliable systems.",
    metrics: [
